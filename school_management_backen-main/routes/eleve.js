...
const eleveController= require("../controllers/eleve")
    ...
    router.post("/getEleveOfficialClassement", eleveController.getEleveOfficialClassement)
    router.post("/getEleveOfficialClassementByTicket", eleveController.getEleveOfficialClassementByTicket)
