...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 25 mars 2024 à 23:36
		...
		SELECT 
            ...
            (
				select 
					count(tickets.id)
                    from tickets
				where tickets.classeId = classeId and tickets.typeEvaluation = "Officielle" and  tickets.sessionId = sessionId
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `eleves_getEleveOfficialClassementByTicket` (`classeId` INT, `ticketId` INT)   BEGIN
		SELECT 
			eleves.id,
			eleves.sessionId,
			eleves.classeId,
	...
	sum(notes.valeur) /
    (
		select count(ticket_matieres.tiketId)
   ...
   from notes 
   inner JOIN tickets on notes.ticketId = tickets.id
   where  notes.eleveId = eleves.id  and tickets.typeEvaluation = "Officielle"
                ) as moyenneAnnuelle
		 FROM eleves
         inner JOIN classses on eleves.classeId = classses.id 
         where eleves.estActif =1 and classses.estActif = 1 and classses.id = classeId; 
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `students_getNote` (`classeId` INT, `sessionId` INT)   BEGIN
    CREATE TEMPORARY TABLE IF NOT EXISTS temp_notes_summary (
        ...
        nom VARCHAR(255),
        prenoms VARCHAR(255),
        numeroTuteur1 VARCHAR(255),
        numeroTuteur2 VARCHAR(255),
        numeroTuteur4 VARCHAR(255),
        moyenne_annuelle DECIMAL(10,2)
    );

    -- Sélectionner tous les élèves actifs dans la classe spécifiée
    INSERT INTO temp_notes_summary
    SELECT 
        eleves.id,
        eleves.sessionId,
        eleves.classeId,
        ...
        eleves.numeroTuteur2,
        eleves.numeroTuteur4,
        COALESCE(SUM(notes.valeur), 0) AS moyenne_annuelle
    FROM 
        eleves
    INNER JOIN 
        classses ON eleves.classeId = classses.id 
    LEFT JOIN 
        notes ON eleves.id = notes.eleveId
    WHERE 
        eleves.estActif = 1 
        AND classses.estActif = 1 
        AND classses.id = classeId
        AND eleves.sessionId = sessionId
    GROUP BY 
        eleves.id, eleves.sessionId, eleves.classeId, eleves.matricule, eleves.nom, eleves.prenoms, eleves.numeroTuteur1, eleves.numeroTuteur2, eleves.numeroTuteur4;

    -- Calcul du nombre total de tickets officiels dans la session
    SET @totalTickets = (
        SELECT COUNT(DISTINCT tickets.id)
        FROM tickets
        WHERE tickets.sessionId = sessionId AND tickets.typeEvaluation = 'Officielle'
    );

    -- Mettre à jour la moyenne annuelle en fonction du nombre total de tickets officiels
    UPDATE temp_notes_summary
    SET moyenne_annuelle = moyenne_annuelle / @totalTickets
    WHERE @totalTickets > 0;

    -- Sélection des résultats
    SELECT * FROM temp_notes_summary;

    -- Supprimer la table temporaire
    DROP TEMPORARY TABLE IF EXISTS temp_notes_summary;
END$$
...
(805, 8, 88, 6, 6, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(806, 8, 88, 7, 3, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(807, 8, 88, 8, 2, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(808, 8, 88, 9, 1, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(809, 8, 88, 10, 0, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(810, 8, 105, 6, 4, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(811, 8, 105, 7, 4, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(812, 8, 105, 8, 5, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(813, 8, 105, 9, 9, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(814, 8, 105, 10, 7, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(815, 8, 106, 6, 5, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(816, 8, 106, 7, 2, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(817, 8, 106, 8, 3, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(818, 8, 106, 9, 8, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(819, 8, 106, 10, 10, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 13:24:00', 5, '2024-03-24 13:24:00', 5),
(820, 9, 88, 7, 5, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5),
(821, 9, 88, 8, 9, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5),
(822, 9, 88, 9, 8, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5),
(823, 9, 105, 7, 10, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5),
(824, 9, 105, 8, 10, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5),
(825, 9, 105, 9, 10, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5),
(826, 9, 106, 7, 1, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5),
(827, 9, 106, 8, 10, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5),
(828, 9, 106, 9, 9, 'Semestre 1', '', 0, 0, '', 1, '2024-03-24 15:13:02', 5, '2024-03-24 15:13:02', 5);
