...
--
-- Dumping data for table `fiche_renseignements`
--
...
--
-- Dumping data for table `modeaccess`
--
...
--
-- Dumping data for table `onglets`
--
...
--
-- Dumping data for table `quartierdistricts`
--
...
--
-- Dumping data for table `storysales`
--
...
INSERT INTO `tickets` (`id`, `sessionId`, `classeId`, `libelle`, `observations`, `estActif`, `creationDate`, `creationUserId`, `modifDate`, `modifUserId`) VALUES
(6, 1, 2, 'Examen controle 1', '', 1, '2023-12-16 16:45:36', 5, '2023-12-16 16:45:36', 5),
...
(14, 1, 11, 'Evaluation du second trimestre', '', 1, '2024-02-18 15:06:20', 5, '2024-02-18 15:06:20', 5);
...
--
-- Dumping data for table `ticket_matieres`
--
...
--
-- Dumping data for table `usergroupes`
--
...
--
-- Indexes for table `enseignantclasses`
--
...
--
-- Indexes for table `quartierdistricts`
--
...
--
-- Indexes for table `smsenvoyes`
--
ALTER TABLE `smsenvoyes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `storysales`
--
...
--
-- Indexes for table `ticket_matieres`
--
...
--
-- Indexes for table `tranches_mois`
--
...
--
-- Indexes for table `userconnexions`
--
...
--
-- AUTO_INCREMENT for table `modeaccess`
--
ALTER TABLE `modeaccess`
...
--
-- AUTO_INCREMENT for table `onglets`
--
ALTER TABLE `onglets`
...
--
-- AUTO_INCREMENT for table `payss`
--
ALTER TABLE `payss`
...
--
-- AUTO_INCREMENT for table `quartierdistricts`
--
ALTER TABLE `quartierdistricts`
...
--
-- AUTO_INCREMENT for table `smsenvoyes`
--
ALTER TABLE `smsenvoyes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `storysales`
--
ALTER TABLE `storysales`
...
--
-- AUTO_INCREMENT for table `tranches_mois`
--
ALTER TABLE `tranches_mois`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `userconnexions`
--
ALTER TABLE `userconnexions`
...
--
-- Constraints for table `fiche_renseignements`
--
ALTER TABLE `fiche_renseignements`
...
--
-- Constraints for table `quartierdistricts`
--
ALTER TABLE `quartierdistricts`
...
--
-- Constraints for table `storysales`
--
ALTER TABLE `storysales`
...
--
-- Constraints for table `ticket_matieres`
--
ALTER TABLE `ticket_matieres`
...
--
-- Constraints for table `tranches`
--
ALTER TABLE `tranches`
