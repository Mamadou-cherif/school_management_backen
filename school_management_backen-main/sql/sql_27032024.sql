...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 27 mars 2024 à 23:40
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `eleves_getEleveOfficialClassement` (`classeId` INT, `sessionId` INT)   BEGIN
        ...
        (
            ...
            FROM 
                notes 
            INNER JOIN 
                tickets ON notes.ticketId = tickets.id
            WHERE 
                eleves.estActif = 1 
                AND notes.eleveId = eleves.id 
                AND tickets.sessionId = sessionId 
                AND tickets.typeEvaluation = "Officielle"
        ), 2) as moyenneAnnuelle
		 FROM eleves
         inner JOIN classses on eleves.classeId = classses.id 
         where classses.estActif = 1 and eleves.classeId = classeId and eleves.estActif =1
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `eleves_getEleveOfficialClassementByTicket` (`classeId` INT, `ticketId` INT)   BEGIN
        ...
        (
			SELECT 
            SUM(notes.valeur * matieres.coefficient) / SUM(matieres.coefficient)
        FROM 
            notes 
        INNER JOIN 
            tickets ON notes.ticketId = tickets.id
        INNER JOIN
            matieres ON notes.matiereId = matieres.id
        WHERE 
            notes.eleveId = eleves.id
            AND notes.ticketId = ticketId
            AND notes.estActif = 1  
            AND tickets.typeEvaluation = "Officielle"
            ) 
		 ...
		 FROM eleves
         inner JOIN classses on eleves.classeId = classses.id 
         where eleves.estActif =1 and classses.estActif = 1 and eleves.classeId = classeId
         order by moyenneAnnuelle desc; 
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `notes_calculeMoyenneParClasseEtSession` (`classeId` INT, `sessionId` INT)   BEGIN
 SELECT 
			notes.id,
			notes.ticketId,
			notes.matiereId,
		 ...
		 FROM notes
         INNER JOIN
			eleves on notes.eleveId = eleves.id
		 INNER JOIN
			classses on eleves.classeId = classses.id
		 INNER JOIN
			matieres on notes.matiereId = matieres.id
            
         where eleves.sessionId = sessionId and eleves.estActif = 1 and eleves.classeId = classeId;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `notes_getMoyenneByTicketAndEleveId` (`ticketId` INT, `eleveId` INT)   BEGIN
	 select ROUND(
        (
				 SELECT 
            SUM(notes.valeur * matieres.coefficient) / SUM(matieres.coefficient)
        ...
        INNER JOIN
            matieres ON notes.matiereId = matieres.id
        WHERE 
            notes.eleveId = eleveId
            AND notes.ticketId = ticketId
            AND notes.estActif = 1  
            AND tickets.typeEvaluation = "Officielle") , 2) as moyenneAnnuelle;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `note_calculeMoyenneParClasseEtSession` (`classeId` INT, `sessionId` INT)   BEGIN
 SELECT 
			notes.id,
			notes.ticketId,
			notes.matiereId,
...
(105, 'ticket_sm', 'Tickets', '', '/ticket/consultationTicket', 0, 15, 'Prive', 'sousmenuprogrammeprioritaire.png', 1, '2024-02-29 22:20:28', 5, '2024-02-29 22:20:28', 5);
...
(829, 8, 88, 6, 3, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:50', 5, '2024-03-26 13:19:50', 5),
(830, 8, 88, 7, 4, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:50', 5, '2024-03-26 13:19:50', 5),
(831, 8, 88, 8, 1, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:50', 5, '2024-03-26 13:19:50', 5),
(832, 8, 88, 9, 10, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:50', 5, '2024-03-26 13:19:50', 5),
(833, 8, 88, 10, 9, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:50', 5, '2024-03-26 13:19:50', 5),
(834, 8, 105, 6, 9, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(835, 8, 105, 7, 2, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(836, 8, 105, 8, 7, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(837, 8, 105, 9, 6, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(838, 8, 105, 10, 5, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(839, 8, 106, 6, 3, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(840, 8, 106, 7, 3, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(841, 8, 106, 8, 8, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(842, 8, 106, 9, 7, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(843, 8, 106, 10, 4, 'Semestre 1', '', 0, 0, '', 1, '2024-03-26 13:19:51', 5, '2024-03-26 13:19:51', 5),
(844, 9, 88, 7, 3, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5),
(845, 9, 88, 8, 2, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5),
(846, 9, 88, 9, 5, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5),
(847, 9, 105, 7, 10, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5),
(848, 9, 105, 8, 5, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5),
(849, 9, 105, 9, 5, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5),
(850, 9, 106, 7, 3, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5),
(851, 9, 106, 8, 3, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5),
(852, 9, 106, 9, 4, '', NULL, 0, 0, '', 1, '2024-03-26 13:24:06', 5, '2024-03-26 13:24:06', 5);
