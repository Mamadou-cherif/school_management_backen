...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 15 oct. 2023 à 10:07
...
--
-- Base de données : `schoolpayementmanager`
--
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `classses_insert` (`ecoleId` INT(11), `enseignantId` INT(11), `niveau` INT(11), `libelle` VARCHAR(150), `creationUserId` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `classses_selectBy` (`id` INT(11), `ecoleId` INT(11), `enseignantId` INT(11), `niveau` INT(11), `libelle` VARCHAR(150), `estActif` TINYINT(4), `creationDate` DATETIME, `creationUserId` INT(11), `modifDate` DATETIME, `modifUserId` INT(11))   BEGIN
 DECLARE requeteSql varchar(500); 
	 SET @requeteSql :=   
		 'SELECT
			classses.id,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `classses_update` (`id` INT, `ecoleId` INT(11), `enseignantId` INT(11), `niveau` INT(11), `libelle` VARCHAR(150), `modifDate` DATETIME, `modifUserId` INT)   BEGIN
	 UPDATE classses
		 SET 
			ecoleId = ecoleId, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `ecoles_update` (`id` INT, `libelle` VARCHAR(45), `slogan` VARCHAR(5), `dateCreation` VARCHAR(45), `modifDate` DATETIME, `modifUserId` INT)   BEGIN
	 UPDATE ecoles
		 SET 
			libelle = libelle, 
			slogan = slogan, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `fiche_renseignements_insert` (`classeId` INT(11), `prixMois` DOUBLE, `creationUserId` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `fiche_renseignements_selectBy` (`id` INT(11), `classeId` INT(11), `prixMois` DOUBLE, `estActif` TINYINT(4), `creationDate` DATETIME, `creationUserId` INT(11), `modifDate` DATETIME, `modifUserId` INT(11))   BEGIN
 DECLARE requeteSql varchar(500); 
	 SET @requeteSql :=   
		 'SELECT
			fiche_renseignements.id,
	 ...
	 END IF; 
	 IF prixMois IS NOT NULL THEN 
		 SET @requeteSql := CONCAT(@requeteSql, ' AND fiche_renseignements.prixMois = "',prixMois,'"');
	 END IF; 
	 IF estActif IS NOT NULL THEN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `fiche_renseignements_update` (`id` INT, `classeId` INT(11), `prixMois` DOUBLE, `modifDate` DATETIME, `modifUserId` INT)   BEGIN
	 UPDATE fiche_renseignements
		 SET 
			classeId = classeId, 
			prixMois = prixMois, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `payements_insert` (`eleveId` INT(11), `trancheId` INT(11), `typePayements` VARCHAR(150), `mois` VARCHAR(45), `prix` DOUBLE, `datePayement` VARCHAR(45), `creationUserId` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `payements_selectBy` (`id` INT(11), `eleveId` INT(11), `trancheId` INT(11), `typePayements` VARCHAR(150), `mois` VARCHAR(45), `prix` DOUBLE, `datePayement` VARCHAR(45), `estActif` TINYINT(4), `creationDate` DATETIME, `creationUserId` INT(11), `modifDate` DATETIME, `modifUserId` INT(11))   BEGIN
 DECLARE requeteSql varchar(500); 
	 SET @requeteSql :=   
		 'SELECT
			payements.id,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `payements_update` (`id` INT, `eleveId` INT(11), `trancheId` INT(11), `typePayements` VARCHAR(150), `mois` VARCHAR(45), `prix` DOUBLE, `datePayement` VARCHAR(45), `modifDate` DATETIME, `modifUserId` INT)   BEGIN
	 UPDATE payements
		 SET 
			eleveId = eleveId, 
			trancheId = trancheId, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `tranches_insert` (`ecoleId` INT(11), `libelle` VARCHAR(45), `pourcentage` INT(11), `creationUserId` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `tranches_selectBy` (`id` INT(11), `ecoleId` INT(11), `libelle` VARCHAR(45), `pourcentage` INT(11), `estActif` TINYINT(4), `creationDate` DATETIME, `creationUserId` INT(11), `modifDate` DATETIME, `modifUserId` INT(11))   BEGIN
 DECLARE requeteSql varchar(500); 
	 SET @requeteSql :=   
		 'SELECT
			tranches.id,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `tranches_update` (`id` INT, `ecoleId` INT(11), `libelle` VARCHAR(45), `pourcentage` INT(11), `modifDate` DATETIME, `modifUserId` INT)   BEGIN
	 UPDATE tranches
		 SET 
			ecoleId = ecoleId, 
			libelle = libelle, 
...
(1, 'Sékou sylla\'s school', NULL, '2023-09-22', 1, '2023-10-14 22:50:23', 1, '2023-10-14 22:50:23', 1),
(2, 'Mariame thiam', NULL, '2023-09-22', 1, '2023-10-14 23:15:37', 1, '2023-10-14 23:15:37', 1);
...
CREATE TABLE `fiche_renseignements` (
  `id` int(11) NOT NULL,
  `classeId` int(11) NOT NULL,
  `prixMois` double NOT NULL DEFAULT 0,
  `estActif` tinyint(4) NOT NULL DEFAULT 1,
  `creationDate` datetime NOT NULL,
  `creationUserId` int(11) NOT NULL,
  `modifDate` datetime NOT NULL,
...
CREATE TABLE `payements` (
  ...
  `typePayements` varchar(150) NOT NULL,
...
INSERT INTO `tranches` (`id`, `ecoleId`, `libelle`, `pourcentage`, `estActif`, `creationDate`, `creationUserId`, `modifDate`, `modifUserId`) VALUES
(1, 2, 'Première tranche', 15, 1, '2023-10-15 07:43:57', 1, '2023-10-15 07:43:57', 1),
(2, 2, 'Deuxième  tranche', 25, 1, '2023-10-15 07:45:04', 1, '2023-10-15 07:45:04', 1),
(3, 2, 'Troisième tranche', 45, 1, '2023-10-15 07:45:37', 1, '2023-10-15 07:45:37', 1);
...
(1, 1, 'Barry', 'Mamadou Cherif', NULL, '621196376', '5f4dcc3b5aa765d61d8327deb882cf99', 417, 1, '2023-10-14 23:18:13', 1, '2023-10-14 23:18:13', 1),
(2, 2, 'Diallo', 'Fatoumata', NULL, '621196376', '5f4dcc3b5aa765d61d8327deb882cf99', 50, 1, '2023-10-15 08:02:20', 1, '2023-10-15 08:02:20', 1),
(3, 2, 'Diallo', 'Fatoumata', NULL, '621196376', '5f4dcc3b5aa765d61d8327deb882cf99', 50, 1, '2023-10-15 08:02:21', 1, '2023-10-15 08:02:21', 1),
(4, 2, 'Diallo', 'Fatoumata', NULL, '621196376', '5f4dcc3b5aa765d61d8327deb882cf99', 50, 1, '2023-10-15 08:02:22', 1, '2023-10-15 08:02:22', 1),
(5, 2, 'Diallo', 'Fatoumata', NULL, '621196376', '5f4dcc3b5aa765d61d8327deb882cf99', 50, 1, '2023-10-15 08:04:28', 1, '2023-10-15 08:04:28', 1);
...
ALTER TABLE `schoolpayementmanager`.`classses` 
ADD COLUMN `etape` VARCHAR(245) NOT NULL AFTER `niveau`;


USE `schoolpayementmanager`;
DROP procedure IF EXISTS `classses_insert`;

USE `schoolpayementmanager`;
DROP procedure IF EXISTS `schoolpayementmanager`.`classses_insert`;
;

DELIMITER $$
USE `schoolpayementmanager`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `classses_insert`(ecoleId int(11), enseignantId int(11), niveau int(11),etape varchar(245), libelle varchar(150), creationUserId INT)
BEGIN
	 INSERT INTO classses( 
		 id, 
		 ecoleId,
...
USE `schoolpayementmanager`;
DROP procedure IF EXISTS `schoolpayementmanager`.`classses_selectAll`;
;

DELIMITER $$
USE `schoolpayementmanager`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `classses_selectAll`(estActif TINYINT, debut INT, fin INT)
BEGIN 
	 DECLARE requeteSql varchar(500); 
	 Set @requeteSql := 'SELECT 
			classses.id,
...
USE `schoolpayementmanager`;
DROP procedure IF EXISTS `schoolpayementmanager`.`classses_selectById`;
;

DELIMITER $$
USE `schoolpayementmanager`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `classses_selectById`(id int)
BEGIN
		 SELECT 
			classses.id,
			classses.ecoleId,
...
USE `schoolpayementmanager`;
DROP procedure IF EXISTS `schoolpayementmanager`.`classses_update`;
;

DELIMITER $$
USE `schoolpayementmanager`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `classses_update`(id int, ecoleId int(11), enseignantId int(11), niveau int(11),etape varchar(245),  libelle varchar(150),  modifDate DATETIME, modifUserId INT)
BEGIN
	 UPDATE classses
		 SET 
			ecoleId = ecoleId, 
...
DELIMITER $$
USE `schoolpayementmanager`$$
CREATE PROCEDURE `users_getEnseignantNotAffectedToClasses` (ecoleId INT)
BEGIN
	SELECT 
			users.id,
			users.ecoleId,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `classses_selectBy`( id int(11),ecoleId int(11),enseignantId int(11),niveau int(11),etape varchar(245), libelle varchar(150),estActif tinyint(4),creationDate datetime,creationUserId int(11),modifDate datetime,modifUserId int(11))
BEGIN
 DECLARE requeteSql varchar(500); 
	 SET @requeteSql :=   
		 'SELECT
			...
			classses.enseignantId,
			classses.niveau,
            `users`.`name` +' '+ `users`.`prenoms` as enseignant,
            classses.etape,
			classses.libelle,
			classses.estActif,
			classses.creationDate,
